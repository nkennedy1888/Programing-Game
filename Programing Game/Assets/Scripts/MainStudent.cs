...
public class MainStudent : MonoBehaviour
{
    ...
    public GameObject leaderboard_scrollView;
    ...
    void Start()
    {
        ...
        leaderboard_scrollView.SetActive(false);
    ...
    public void ToggleLeaderboardVis()
    {
        leaderboard_scrollView.SetActive(!leaderboard_scrollView.activeSelf);
    }
